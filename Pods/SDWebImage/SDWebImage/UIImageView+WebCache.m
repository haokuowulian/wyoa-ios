...
- (void)sd_setImageWithURL:(nullable NSString *)url {
    NSURL *imageUrl=[NSURL URLWithString:url];
    [self sd_setImageWithURL:imageUrl placeholderImage:nil options:0 progress:nil completed:nil];
}

- (void)sd_setImageWithURL:( NSString *)url placeholderImage:(nullable UIImage *)placeholder {
    NSURL *imageUrl=[NSURL URLWithString:url];
    [self sd_setImageWithURL:imageUrl placeholderImage:placeholder options:0 progress:nil completed:nil];
}

- (void)sd_setImageWithURL:(nullable NSString *)url placeholderImage:(nullable UIImage *)placeholder options:(SDWebImageOptions)options {
      NSURL *imageUrl=[NSURL URLWithString:url];
    [self sd_setImageWithURL:imageUrl placeholderImage:placeholder options:options progress:nil completed:nil];
}
