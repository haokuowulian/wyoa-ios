...
#import "TimeUtil.h"
@interface MyShengGouViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *shenggouArray;
@end

@implementation MyShengGouViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取我发起的物品申购..."];
    [self getMyShengGou];
    //获取通知中心单例对象
...
#pragma mark 获取我的物品申购列表
-(void)getMyShengGou{
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *userId=[userDefault objectForKey:@"userId"];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"oaOffice/getMylistBuy.do",apikey];
