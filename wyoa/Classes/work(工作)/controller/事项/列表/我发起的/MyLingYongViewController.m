...
#import "TimeUtil.h"
@interface MyLingYongViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *lingyongArray;
@end

@implementation MyLingYongViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取我发起的物品领用..."];
    [self getMyLingYong];
    //获取通知中心单例对象
...
#pragma mark 获取我的领用列表
-(void)getMyLingYong{
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *userId=[userDefault objectForKey:@"userId"];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"oaOffice/loginItemsapply.do",apikey];
