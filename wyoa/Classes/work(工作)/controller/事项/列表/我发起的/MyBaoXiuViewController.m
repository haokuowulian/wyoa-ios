...
#import "TimeUtil.h"
@interface MyBaoXiuViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *baoxiuArray;
@end

@implementation MyBaoXiuViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取我发起的报修..."];
    [self getMyBaoXiua];
    //获取通知中心单例对象
...
#pragma mark 获取我的报修列表
-(void)getMyBaoXiua{
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *userId=[userDefault objectForKey:@"userId"];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"oaOffice/getInlistFix.do",apikey];
