...
#import "TimeUtil.h"
@interface MyQingJiaViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *qingjiaArray;
@end

@implementation MyQingJiaViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取我发起的事假..."];
    [self getMyQingJia];
    //获取通知中心单例对象
...
#pragma mark 获取我的请假列表
-(void)getMyQingJia{
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *userId=[userDefault objectForKey:@"userId"];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"oaOffice/getInlistApprove.do",apikey];
