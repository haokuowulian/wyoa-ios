//
//  TiaoBanChaoSongViewController.m
//  wyoa
//
...
#import "TimeUtil.h"
@interface TiaoBanChaoSongViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *tiaobanArray;
@end

@implementation TiaoBanChaoSongViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取抄送我的调班..."];
    [self getChaoSong];
    //获取通知中心单例对象
