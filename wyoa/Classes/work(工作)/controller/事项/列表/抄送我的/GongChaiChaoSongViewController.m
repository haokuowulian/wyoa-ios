//
//  GongChaiChaoSongViewController.m
//  wyoa
//
...
#import "TimeUtil.h"
@interface GongChaiChaoSongViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *gongchaiArray;
@end

@implementation GongChaiChaoSongViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取抄送我的公差..."];
    [self getChaoSong];
    //获取通知中心单例对象
