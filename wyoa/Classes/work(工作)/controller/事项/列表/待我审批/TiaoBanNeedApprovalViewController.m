//
//  TiaoBanNeedApprovalViewController.m
//  wyoa
//
...
#import "TimeUtil.h"
@interface TiaoBanNeedApprovalViewController ()
@property(nonatomic,assign)NSInteger pageIndex;
@property(nonatomic,strong)NSMutableArray *tiaobanArray;
@end

@implementation TiaoBanNeedApprovalViewController
...
- (void)viewDidLoad {
    ...
    self.pageIndex=0;
    [MBProgressHUD showMessage:@"正在获取待审批调班..."];
    [self getShenPi];
...
#pragma mark 获取待审批调班列表
-(void)getShenPi{
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *userId=[userDefault objectForKey:@"userId"];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"oaCustom/doDealWithTransfer.do",apikey];
