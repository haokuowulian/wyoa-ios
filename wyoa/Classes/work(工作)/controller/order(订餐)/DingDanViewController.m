...
- (void)viewDidAppear:(BOOL)animated{
    ...
    UIBarButtonItem *rightitem = [[UIBarButtonItem alloc] initWithTitle:@"" style:(UIBarButtonItemStyleDone) target:self action:nil];
...
-(void)getOrderList{
    ...
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"mess/getInOrderList.do",apikey];
...
//                           };
    NSDictionary *params=@{@"userId":userId,
                           ...
                           @"pageSize":@"10",
                           @"startTime":[TimeUtil getCurrentTimesNOHour],
                           @"endTime":[TimeUtil getCurrentTimesNOHour]
                           };
