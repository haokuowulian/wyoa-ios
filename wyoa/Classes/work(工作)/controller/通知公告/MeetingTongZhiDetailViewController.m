//
//  MeetingTongZhiDetailViewController.m
//  wyoa
//
...
@interface MeetingTongZhiDetailViewController ()

@end

@implementation MeetingTongZhiDetailViewController
...
#pragma mark 获取详情
-(void)getDetail{
    [MBProgressHUD showMessage:@"正在获取会议详情..."];
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"noteNew/getInfoConference.do",apikey];
    NSDictionary *params=@{@"conferenceId":self.id};
