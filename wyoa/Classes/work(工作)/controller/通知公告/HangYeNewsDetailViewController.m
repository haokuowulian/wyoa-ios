//
//  HangYeNewsDetailViewController.m
//  wyoa
//
...
@interface HangYeNewsDetailViewController ()

@end

@implementation HangYeNewsDetailViewController
...
#pragma mark 获取详情
-(void)getDetail{
    [MBProgressHUD showMessage:@"正在获取新闻详情..."];
    NSUserDefaults *userDefault=[NSUserDefaults standardUserDefaults];
    NSString *apikey=[userDefault objectForKey:@"apikey"];
    NSString *url=[NSString stringWithFormat:@"%@%@?apikey=%@",baseUrl,@"noteNew/getInfoNews.do",apikey];
    NSDictionary *params=@{@"newsId":self.id};
